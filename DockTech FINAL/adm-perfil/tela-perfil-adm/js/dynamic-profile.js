...
let administradorActions = {
    squads: {
        ...
        hasContent: false,
        hasRedirect:true,
        redirect: "../../adm-squad/tela-adm-squads-inicial/tela-adm-squads.html"
        // hasButton: true,
        // button: {
        //     classe: "edit-squads",
    ...
    usuarios: {
        ...
        hasContent:false,
        hasRedirect:true,
        redirect:"../../adm-user/tela-adm-usuario-inicial/tela-adm-usuario.html"
    },
    instituiçõesEmpresas: {
        name: "Instituições/Empresas",
        hasContent: false,
        hasRedirect: true,
        redirect: "../../adm-instituicoes/tela-adm-instituicoes/tela-adm-instituicoes.html"
    },
    trilhas: {
        name: "Trilhas",
        hasContent:false,
        hasRedirect:true,
        redirect:"../../adm-trilha/tela-adm-trilha/telaAdmTrilha.html"
    }
    // notificacoes: {
    //     name: "Notificações",
    //     hasContent: false
